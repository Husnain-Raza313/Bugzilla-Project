...
const BugShow = () => {
  ...
  return (
    ...
    <h4>Description: {bug.description === "" ? <span>None</span> : bug.description}</h4>
    <h4>Screenshot:</h4>
      {bug.screenshot.url === null ? <h6>(No Screenshot Available)</h6> : <div><img src={bug.screenshot.url} className="bug-screenshot" /></div> }
    <h4>Deadline: {bug.deadline === null ? <span>None</span> : bug.deadline}</h4>
